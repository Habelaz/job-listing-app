  ...
  return (
    ...
    <div className='flex justify-between'>
      ...
      <nav >
        ...
        <Link className="text-xl font-semibold" href='/signin'>login</Link>
        <Link className="text-xl font-semibold" href='/signup'>signup</Link>
        </div>
      </nav>
      </div>
    <div className='text-center'>
        ...
        <Link className="text-xl font-semibold bg-[#334155] text-white p-2 rounded-lg m-2" href='signup'>Get started</Link>
      </div>
